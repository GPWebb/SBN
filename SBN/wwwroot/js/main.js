...
(function ($) {
    ...
    $(".hamburger-open").on('click', function () {
        $(".hamburger-menu-wrapper").addClass("show-hamburger-menu");
        $(".hamburger-menu-overlay").addClass("active");
        $(".nav-options").addClass("hamburger-change");
    });

    $(".hamburger-menu-overlay").on('click', function () {
        $(".hamburger-menu-wrapper").removeClass("show-hamburger-menu");
        $(".hamburger-menu-overlay").removeClass("active");
        $(".nav-options").removeClass("hamburger-change");
    });
